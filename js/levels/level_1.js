Skinny_Ninja.level_1 = function(game) { 
...
Skinny_Ninja.level_1.prototype = {
    ...
    build_player: function () {
        ...
        //create the player
        hero.create(100, this.game.world.height - 100);
    ...
    build_items: function () {
        ...
        //create the items
        //type 0 = katana_0
        item.create(0, 350, 80);
        
        //type 1 = ruby (doesn't exist upon creation)
        item.create(1, this.game.world.width - 150, 400);
